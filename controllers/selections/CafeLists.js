...
module.exports = async (req, res) => {
  ...
  const dong = [
    ...
    "사직동", "체부동", "필운동", "내자동", "통의동", "적선동", "세종로", "도렴동", "당주동", "내수동", "신문로1가", "신문로2가",
    "삼청동", "팔판동", "안국동", "소격동", "화동", "사간동", "송현동",
    "홍지동", "신영동",
    "구기동",
    "평동", "송월동", "홍파동", "교북동", "행촌동",
    "재동", "계동", "원서동",
    "청진동", "서린동", "수송동", "중학동", "공평동", "관훈동", "견지동", "권농동", "운니동", "익선동", "경운동", "관철동", "인사동", "낙원동", "와룡동", "훈정동", "묘동", "봉익동", "돈의동", "장사동", "관수동", "인의동", "예지동", "원남동",
    "효제동", "연지동", "충신동",
    "연건동", "동숭동",
    "명륜1가", "명륜2가", "명륜3가", "명륜4가",
    "북창동", "태평로2가", "남대문로2가", "남대문로3가", "남대문로4가", "서소문동", "정동", "순화동", "의주로1가", "충정로1가", "봉래동1가",
    "회현동1가", "회현동2가", "남창동", "남대문로3가", "남대문로4가", "남대문로5가", "봉래동1가", "봉래동2가", "충정로1가", "순화동",
    "명동1가", "명동2가", "충무로1가", "충무로2가", "저동1가", "남산동1가", "남산동2가", "남산동3가", "태평로1가", "무교동", "다동", "을지로1가", "을지로2가", "삼각동", "남대문로1가", "남대문로2가", "수하동", "장교동", "수표동", "예장동", "회현동1가", "회현동2가", "회현동3가",
    "필동1가", "필동2가", "필동3가", "남학동", "주자동", "예장동", "충무로3가", "충무로4가", "충무로5가", "장충동2가", "묵정동", "장충동1가",
    "광희동1가", "광희동2가", "쌍림동", "을지로6가", "을지로7가", "충무로4가", "충무로5가", "인현동", "예관동", "오장동",
    "을지로3가", "을지로4가", "을지로5가", 
    "주교동", "방산동", "입정동", "산림동", "초동", "인현동", "저동2가",
    "무학동", "흥인동",
    "의주로2가", "만리동1가", "만리동2가",
